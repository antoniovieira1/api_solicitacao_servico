...
def send_notification(recipient_email, ossm_id):
    subject = f"Análise Laboratorial Requerida - OSSM: #{ossm_id}"
    message_body = f"Olá, Equipe do Laboratório,<br><br>A <b>OSSM {ossm_id}</b> requer uma avaliação laboratorial. Por favor, acesse o sistema para fornecer sua análise."
